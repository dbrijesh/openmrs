...
public class PersonName extends BaseChangeableOpenmrsData implements java.io.Serializable, Cloneable, Comparable<PersonName> {
	...
	@FullTextField(name = "givenNameExact", analyzer = LuceneAnalyzers.EXACT_ANALYZER)
	...
	@FullTextField(name = "middleNameExact", analyzer = LuceneAnalyzers.EXACT_ANALYZER)
	...
	@FullTextField(name = "familyNameExact", analyzer = LuceneAnalyzers.EXACT_ANALYZER)
	...
	@FullTextField(name = "familyName2Exact", analyzer = LuceneAnalyzers.EXACT_ANALYZER)
