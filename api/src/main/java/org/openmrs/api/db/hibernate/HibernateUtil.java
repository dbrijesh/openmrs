...
public class HibernateUtil {
	...
	public static boolean isPostgreSQLDialect(SessionFactory sessionFactory) {
		...
		if (isPostgreSQLDialect == null) {
			// PostgreSQL82Dialect removed in Hibernate 6; use PostgreSQLDialect and check via isAssignableFrom
			Class<?> dialectClass = getDialect(sessionFactory).getClass();
			isPostgreSQLDialect = PostgreSQLDialect.class.isAssignableFrom(dialectClass);
		}
