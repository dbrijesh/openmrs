...
public class DbSession {
	 ...
	 *
	 * @param queryString The HQL query
	 * @param resultClass The result type class
	 ...
	 * @return The query instance for manipulation and execution
	 */
	// createFilter removed in Hibernate 6; use HQL with JOIN or collection queries instead
	@Deprecated
	public Query createFilter(Object collection, String queryString) {
		throw new UnsupportedOperationException("createFilter removed in Hibernate 6");
	}
	 ...
	 */
	// disconnect() removed in Hibernate 6 - connection management is handled internally
	Connection disconnect() {
		throw new UnsupportedOperationException("disconnect() removed in Hibernate 6");
	}

	// reconnect() removed in Hibernate 6 - connection management is handled internally
	void reconnect(Connection connection) {
		throw new UnsupportedOperationException("reconnect() removed in Hibernate 6");
	}
