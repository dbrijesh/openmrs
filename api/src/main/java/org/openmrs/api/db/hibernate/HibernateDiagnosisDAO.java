...
public class HibernateDiagnosisDAO implements DiagnosisDAO {
	...
	public List<Diagnosis> getActiveDiagnoses(Patient patient, Date fromDate) {
		...
		if (fromDate != null) {
			hql.append(" and d.dateCreated >= :fromDate");
		}
		hql.append(" order by d.dateCreated desc");

		Query<Diagnosis> query = sessionFactory.getCurrentSession()
		        .createQuery(hql.toString(), Diagnosis.class)
	...
	public List<Diagnosis> getDiagnosesByEncounter(Encounter encounter, boolean primaryOnly, boolean confirmedOnly) {
		...
		TypedQuery<Diagnosis> query = sessionFactory.getCurrentSession()
	...
	public Diagnosis getDiagnosisByUuid(String uuid) {
		return sessionFactory.getCurrentSession()
		        .createQuery("from Diagnosis d where d.uuid = :uuid", Diagnosis.class)
	...
	public List<DiagnosisAttributeType> getAllDiagnosisAttributeTypes() throws DAOException {
		return sessionFactory.getCurrentSession()
		        .createQuery("from DiagnosisAttributeType", DiagnosisAttributeType.class)
		        .list();
	}
	...
	public DiagnosisAttributeType getDiagnosisAttributeTypeByUuid(String uuid) throws DAOException {
		return sessionFactory.getCurrentSession()
		        .createQuery("from DiagnosisAttributeType dat where dat.uuid = :uuid", DiagnosisAttributeType.class)
		        .setParameter("uuid", uuid)
		        .uniqueResult();
	}
	...
	public DiagnosisAttribute getDiagnosisAttributeByUuid(String uuid) throws DAOException {
		return sessionFactory.getCurrentSession()
		        .createQuery("from DiagnosisAttribute da where da.uuid = :uuid", DiagnosisAttribute.class)
		        .setParameter("uuid", uuid)
		        .uniqueResult();
	}
}
