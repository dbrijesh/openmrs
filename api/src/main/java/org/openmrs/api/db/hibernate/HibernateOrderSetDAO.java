...
public class HibernateOrderSetDAO implements OrderSetDAO {
	...
	public List<OrderSet> getOrderSets(boolean includeRetired) throws DAOException {
		StringBuilder hql = new StringBuilder("FROM OrderSet os");
		if (!includeRetired) {
			hql.append(" WHERE os.retired = false");
		}
		return sessionFactory.getCurrentSession()
				.createQuery(hql.toString(), OrderSet.class)
				.list();
	}
	...
	public OrderSet getOrderSetByUniqueUuid(String orderSetUuid) throws DAOException {
		return sessionFactory.getCurrentSession()
				.createQuery("FROM OrderSet o WHERE o.uuid = :uuid", OrderSet.class)
				.setParameter("uuid", orderSetUuid)
				.uniqueResult();
	}
	...
	public OrderSetMember getOrderSetMemberByUuid(String uuid) throws DAOException {
		return sessionFactory.getCurrentSession()
				.createQuery("FROM OrderSetMember osm WHERE osm.uuid = :uuid", OrderSetMember.class)
	...
	public List<OrderSetAttributeType> getAllOrderSetAttributeTypes() {
		return sessionFactory.getCurrentSession()
				.createQuery("FROM OrderSetAttributeType", OrderSetAttributeType.class)
				.list();
	}
	...
	public OrderSetAttributeType getOrderSetAttributeTypeByUuid(String uuid) {
		return sessionFactory.getCurrentSession()
				.createQuery("FROM OrderSetAttributeType t WHERE t.uuid = :uuid", OrderSetAttributeType.class)
				.setParameter("uuid", uuid)
				.uniqueResult();
	}
	...
	public OrderSetAttribute getOrderSetAttributeByUuid(String uuid) {
		return sessionFactory.getCurrentSession()
				.createQuery("FROM OrderSetAttribute a WHERE a.uuid = :uuid", OrderSetAttribute.class)
				.setParameter("uuid", uuid)
				.uniqueResult();
	}
	...
	public OrderSetAttributeType getOrderSetAttributeTypeByName(String name) {
		return sessionFactory.getCurrentSession()
				.createQuery("FROM OrderSetAttributeType t WHERE t.name = :name", OrderSetAttributeType.class)
